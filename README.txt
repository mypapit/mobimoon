...
Copyright
-------------------------------------------
This software is protected under the international copyright law. The use of 
this software is governed under the terms stated in the 'LICENSE.txt' file 
included with this software package.


Source Code
--------------------------------------
You can obtain the source code of this software via Subversion (SVN) from 
http://code.google.com/p/mobimoon, or you can write to info@mypapit.net stating
that you are requesting for Mobimoon source code.
...
You can view the full copy of the License in the 'LICENSE.txt' file
